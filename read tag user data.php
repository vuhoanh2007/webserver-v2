<?php
	...
	if (is_null($data['name'])) {
		$msg = "Thẻ của bạn chưa được đăng ký!!!";
		$data['id']= $id;
		$data['name'] ="--------";
		$data['bd'] ="--------";
		$data['gender'] ="--------";
					...
					<tr>
						<td bgcolor="#f9f9f9">
							<table width="452"  border="0" align="center" cellpadding="5"  cellspacing="0">
								...
								<tr bgcolor="#f2f2f2">
									<td align="left" class="lf">Họ và tên</td>
									<td style="font-weight:bold">:</td>
								...
								<tr>
									...
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['bd'];?></td>
								</tr>
								<tr bgcolor="#f2f2f2">
								...
								<tr>
									<td align="left" class="lf">Lớp</td>
									<td style="font-weight:bold">:</td>
									<td align="left"><?php echo $data['class'];?></td>
								</tr>
								<tr>
									<td align = "left" class= "lf"> Mã học sinh</td>
									<td style =  "font-weight:bold">:</td>
									<td align = "left"><?php echo $data['IDs'];?></td>
								</tr>
							</table>
						</td>
					</tr>
